...
CREATE TABLE IF NOT EXISTS Transit (
	...
	PrimarySite varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
	--
...
ALTER TABLE Transit ADD CONSTRAINT SFK1_Transit1 FOREIGN KEY (PrimarySite) Site (SiteName) ON DELETE RESTRICT ON UPDATE CASCADE;
--
...
CREATE TABLE IF NOT EXISTS Events (
	...
	PrimaryStaff varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
	--
	...
	CONSTRAINT SFK2_Event1 FOREIGN KEY (PrimaryStaff) REFERENCES Employee(UserName) ON DELETE
...
CREATE TABLE IF NOT EXISTS Connects (	
	...
	CONSTRAINT FK6_Connect2 FOREIGN KEY (Route, TransportType) REFERENCES Transit
	(Route, TransportType)
	ON DELETE CASCADE ON UPDATE CASCADE,
	-- 
...
CREATE TABLE IF NOT EXISTS Take (
	...
	CONSTRAINT FK8_Take2 FOREIGN KEY (Route, TransportType) REFERENCES Transit
	(Route, TransportType)
	ON DELETE CASCADE ON UPDATE CASCADE,
	-- 
...
CREATE TABLE IF NOT EXISTS VisitEvent (
	...
	CONSTRAINT FK12_VE2 FOREIGN KEY (SiteName, EventName, StartDate) REFERENCES Events
	(SiteName, EventName, StartDate)
	ON DELETE CASCADE ON UPDATE CASCADE,
	-- 
...
CREATE TABLE IF NOT EXISTS AssignTo (
	...
	CONSTRAINT FK14_AT2 FOREIGN KEY (SiteName, EventName, StartDate) REFERENCES Events
	(SiteName, EventName, StartDate)
	ON DELETE CASCADE ON UPDATE CASCADE,
	-- 
